...
import { readableSupperGroupId, unixTo12HourTime, updateOrderDetails } from '../../../store/supper/action'
    ...
    <>
      {props.supperGroupIsOpen ? (
        <ExpandableSGCard
          ...
          supperGroupId={readableSupperGroupId(props.supperGroup?.supperGroupId)}
