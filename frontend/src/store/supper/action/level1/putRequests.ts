...
export const updateSupperGroup =
  (supperGroupId: string | number | undefined, updatedInfo) => async (dispatch: Dispatch<ActionTypes>) => {
...
export const emptyOrderFoodList =
  (supperGroupId: string, orderId: string) => async (dispatch: Dispatch<ActionTypes>) => {
...
export const updateOrderDetails =
  (orderId: string, newOrderDetails, hasIsLoading: boolean) => async (dispatch: Dispatch<ActionTypes>) => {
...
export const updateFoodInOrder =
  (newFood, orderId: string, foodId: string) => async (dispatch: Dispatch<ActionTypes>) => {
...
export const updateOwnerEdits =
  (supperGroupId: number | undefined, foodId: string | undefined, updates: Updates, forAll: boolean) =>
